...
TrackDraw source code is licensed under the GNU Affero General Public License version 3 only (AGPL-3.0-only). See [LICENSE](LICENSE) for the full license text.

The TrackDraw name, logos, and brand assets are part of the project's identity. The AGPL lets you use, study, modify, and share the source code, but it does not grant trademark rights or permission to present forks, modified versions, hosted instances, or commercial offerings as official TrackDraw products or as endorsed by Dutch Drone Squad.
