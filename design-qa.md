...
- Desktop implementation: `/private/tmp/trackdraw-dashboard-qa-desktop-final.png` (1276 x 718)
- Mobile implementation: `/private/tmp/trackdraw-dashboard-qa-mobile-final.png` (386 x 835)
- Mobile Platform snapshot: `/private/tmp/trackdraw-dashboard-qa-mobile-platform-final.png` (386 x 835)
- Runtime: signed-in administrator at `http://localhost:8788/dashboard`
...
- Product metrics show their visible metric ID, measurement window, owner, start date, and quality so an immature measurement cannot look healthy.
