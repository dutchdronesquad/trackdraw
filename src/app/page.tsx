      ...
      <main>
        ...
        <section id="plans" className="border-border/40 border-t">
          <div className="mx-auto w-full max-w-6xl px-6 py-14 sm:py-20">
            ...
            <div className="-mx-6 overflow-x-auto px-6 pb-2 [scroll-padding-inline:1.5rem] sm:mx-auto sm:max-w-2xl sm:overflow-visible sm:px-0 sm:pb-0 sm:[scroll-padding-inline:0]">
              <div className="flex w-max min-w-full snap-x snap-mandatory gap-4 sm:grid sm:w-auto sm:min-w-0 sm:grid-cols-2">
                ...
                {/* Account */}
                <Reveal delay={0.07}>
                  <div className="border-brand-primary/25 bg-brand-primary/5 from-brand-primary/8 relative mr-6 flex h-full max-w-[19.5rem] min-w-[18.5rem] snap-start flex-col overflow-hidden rounded-2xl border bg-linear-to-br to-transparent p-6 sm:mr-0 sm:max-w-none sm:min-w-0">
