          ...
          <div className="space-y-8">
            <div className="max-w-3xl space-y-4">
              ...
              <p className="text-muted-foreground max-w-2xl text-sm leading-7 sm:text-base">
                The share link may be outdated, incomplete, miscopied, or too
                large for the browser to decode safely. If it was copied with
                confidence, ask for the latest version and try again.
              </p>
            </div>
            ...
            <div className="max-w-4xl">
              ...
              <ol className="text-muted-foreground text-sm leading-relaxed">
                ...
                <li className="flex gap-3 py-2">
                  ...
                  <span>
                    Use a JSON export if the design is too large for URL
                    sharing.
                  </span>
                </li>
              </ol>
