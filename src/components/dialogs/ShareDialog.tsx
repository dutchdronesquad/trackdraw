        ...
        {canNativeShare && (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="text-foreground text-sm font-medium">Share via…</p>
              <p className="text-muted-foreground text-[11px]">
...
export default function ShareDialog({
  ...
  return (
    ...
    >
      <div
        className="border-border/50 bg-card/97 pointer-events-auto w-full max-w-sm overflow-hidden rounded-3xl border p-6 shadow-[0_24px_80px_rgba(15,23,42,0.10)] backdrop-blur"
