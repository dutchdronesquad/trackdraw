      ...
      <div className="bg-background text-foreground relative flex h-[100dvh] overflow-hidden">
        <div className="pointer-events-none absolute top-0 right-0 left-0 z-30 hidden h-11 items-center justify-center lg:flex">
          <div className="flex max-w-[28rem] items-center gap-2 px-6">
            ...
            <span className="border-amber-500/25 bg-amber-500/10 text-amber-500 inline-flex h-5 shrink-0 items-center justify-center rounded-md border px-1.5">
              <span className="inline-flex h-3 items-center text-[9px] leading-none font-semibold uppercase tracking-[0.12em]">
                Beta
              </span>
            </span>
          </div>
