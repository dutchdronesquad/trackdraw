          ...
          <div className="flex h-full flex-col">
            <div className="border-border/60 shrink-0 border-b px-4 py-4">
              <DrawerHeader className="p-0 text-left">
                ...
                <DrawerDescription className="pt-0.5 text-[11px]">
                  Projects, sharing, account and app settings
                </DrawerDescription>
              </DrawerHeader>
            </div>
            ...
            <div className="border-border/60 shrink-0 border-t px-3 py-3">
              ...
              {user ? (
                <button
                  ...
                  disabled={signingOut}
                  className="text-muted-foreground hover:text-foreground hover:bg-muted/70 mt-2 flex h-10 w-full items-center gap-3 rounded-xl px-2.5 text-left text-[13px] transition-colors disabled:pointer-events-none disabled:opacity-60"
                >
